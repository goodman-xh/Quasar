namespace Quasar.Server.Forms
{
    partial class FrmSettings
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.chkAutoListen.Text = "启动时自动监听新连接";
            ...
            this.chkPopup.Text = "在新连接时显示弹出通知(本电脑)";
            ...
            this.chkShowTooltip.Text = "在客户端显示带有系统信息的工具提示(建议不勾选)";
            ...
            this.chkNoIPIntegration.Text = "启用No-Ip.com DNS更新器";
