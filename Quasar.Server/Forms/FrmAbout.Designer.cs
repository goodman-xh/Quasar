namespace Quasar.Server.Forms
{
    partial class FrmAbout
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lblTitle.Text = "aiyeye.net/a0343"; // 保持不变，可能是标识符或网址
            // 
            // lblVersion
            // 
            ...
            this.lblVersion.Text = "%VERSION%"; // 占位符，无需翻译
            ...
            this.btnOkay.Text = "&确定"; // 原 "&Okay" 翻译为 "&确定"
            ...
            this.lblLicense.Text = "许可证"; // 原 "License" 翻译为 "许可证"
            // 
            // lnkCredits
            // 
            ...
            this.lnkCredits.Text = "第三方许可证"; // 原 "3rd-party licenses" 翻译为 "第三方许可证"
            ...
            this.lnkGithubPage.Text = "我的主页"; // 原 "GitHub page" 翻译为 "GitHub页面"
            ...
            this.lblSubTitle.Text = "远程管理工具"; // 原 "Remote Administration Tool" 翻译为 "远程管理工具"
            // 
            // FrmAbout
            // 
