...
namespace Quasar.Server.Forms
{
    public partial class FrmPasswordRecovery : Form
    {
        ...
        {
            Application = "未找到结果", // Translated: "No Results Found"
            Url = "N/A",
            Username = "N/A",
            Password = "N/A"
        };
        ...
        {
            this.Text = WindowHelper.GetWindowTitle("密码恢复", _clients.Length); // Translated: "Password Recovery"
        ...
        {
            groupBox1.Text = $"已恢复的账户 [ {lstPasswords.Items.Count} ]"; // Translated: "Recovered Accounts [ {0} ]"
        }
